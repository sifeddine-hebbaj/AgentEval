    ...
    def _run(message: str, system: Optional[str]) -> str:
        ...
        with span(type="llm_call", name="groq_chat_completion", model=MODEL) as s:
            try:
                ...
                # Groq pricing (as of 2026): llama-3.1-8b-instant - free tier
                cost = 0.0
